...
const Modal = ({ isOpen, onClose, title, children }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
      <div className="bg-slate-800 border border-slate-700 rounded-xl w-full max-w-4xl max-h-[90vh] overflow-y-auto shadow-2xl">
...
function TenantBillingView({ data, showToast, user }) {
  ...
  return (
    <div className="h-[calc(100vh-120px)] flex flex-col md:flex-row gap-6 max-w-7xl mx-auto">
      ...
      {/* MARG-STYLE PROFESSIONAL WHOLESALE INVOICE MODAL */}
      {activeInvoice && (
          ...
          <div className="space-y-4">
            ...
            <div id="invoice-print-area" className="bg-white text-black p-6 rounded-lg border-2 border-black text-[11px] font-sans">
              ...
              <div className="text-center border-b-2 border-black pb-2 mb-2">
                ...
                <p className="text-gray-800 font-medium">Pharmaceutical Distributors & Stockists</p>
